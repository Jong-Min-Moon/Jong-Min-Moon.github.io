...
$$
\begin{equation*}
\hat{\tau}_{AGG} = \frac{n_A}{n} \hat{\tau}_A + \frac{n_B}{n} \hat{\tau}_B
\end{equation*}
$$
...
$$ 
\begin{align*}
\hat{\tau}_{AGG} &= \frac{1}{n} \sum_{i=1}^n \left( \frac{W_i Y_i}{\hat{e}(C_i)} - \frac{(1 - W_i) Y_i}{1 - \hat{e}(C_i)} \right)
\end{align*}
$$
...
$$
\begin{equation*}
\hat{\tau}_{AGG} = \sum_{x \in \mathcal{X}} \frac{n_x}{n} \hat{\tau}(x)
\end{equation*}
$$
...
Now, plug this $$\hat{\tau}(x)$$ back into the outer aggregation sum $\hat{\tau}_{AGG}$. Once again, the subgroup sizes $n_x$ cancel out:
$$ \hat{\tau}_{AGG} = \sum_{x \in \mathcal{X}} \frac{n_x}{n} \left[ \frac{1}{n_x} \sum_{i: X_i=x} \left( \frac{W_i Y_i}{\hat{e}(x)} - \frac{(1 - W_i) Y_i}{1 - \hat{e}(x)} \right) \right] $$
$$ \hat{\tau}_{AGG} = \sum_{x \in \mathcal{X}} \frac{1}{n} \sum_{i: X_i=x} \left( \frac{W_i Y_i}{\hat{e}(X_i)} - \frac{(1 - W_i) Y_i}{1 - \hat{e}(X_i)} \right) $$
...
$$ \hat{\tau}_{AGG} = \frac{1}{n} \sum_{i=1}^n \left( \frac{W_i Y_i}{\hat{e}(X_i)} - \frac{(1 - W_i) Y_i}{1 - \hat{e}(X_i)} \right) $$
