...
toc:
  ...
  - name: "Target Brain Regions"
  - name: "Mouse Task"
  - name: "Task 1: Active Locomotion Analysis"
  - name: "Task 2: Directional Decoding in Visual Cortex (V1 L6)"
...
### Task 2: Directional Decoding in Visual Cortex (V1 L6)
