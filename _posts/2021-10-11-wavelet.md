---
layout: post
title: "Fundamentals of Wavelet Convolution"
date: 2021-10-11
...
### I. Motivation: Why Leave the Fourier Domain?
While the Fourier Transform is fundamental to signal processing, it has two critical limitations when applied to biological time series like EEG:
1.  **Lack of Temporal Localization:** The Fourier kernel (a sine wave) extends infinitely in time. It can tell you *what* frequencies are present, but not *when* they occurred.
2.  **Violation of Stationarity:** Fourier analysis assumes that the statistical properties of the signal do not change over time. Neural data is highly non-stationary, characterized by transient bursts of activity.
